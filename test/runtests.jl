...
# !!! Main.UserApp is configured as an alias for Main.Motregen and you might encounter it in some tests
using Main.Motregen, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "Motregen tests" begin
  @includetests ARGS
end
